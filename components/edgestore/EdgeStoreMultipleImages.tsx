...
const EdgeStoreMultipleImages = React.forwardRef<HTMLInputElement, InputProps>(
  (
          ...
          {value?.map(({ file, progress }, i) => (
            ...
            >
              <div className="flex items-center gap-2 text-gray-500">
                ...
                <div className="grow" />
                <div className="flex w-12 items-center justify-end gap-2 text-xs">
                  {progress === "PENDING" ? (
                    <button
                  ...
                  <button
                    className="rounded-md p-1 transition-colors duration-200 hover:bg-gray-100 hover:text-white dark:hover:bg-red-600"
                    onClick={() => {
                      void onChange?.(
                        value.filter((_, index) => index !== i)
                      );
...
EdgeStoreMultipleImages.displayName = "EdgeStoreMultipleImages";
...
export { EdgeStoreMultipleImages };